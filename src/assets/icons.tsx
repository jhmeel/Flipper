...
export const IconCubeOutline = (props: React.SVGProps<SVGSVGElement>)=>{
  return (
    <svg
      ...
      {...props}
    >
      <path d="M1.857 18.013L11.736 24V12.456L1.857 6.468zm20.286 0V6.468l-9.879 5.988V24zm-.246-12.014L12 0 2.103 5.999 12 11.998z" />
    </svg>
  );
}
...
export const IconSubtask = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      fill="none"
      stroke="currentColor"
